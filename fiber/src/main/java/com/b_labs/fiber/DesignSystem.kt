...
data class DesignSystem(
    val color: ColorValuesContainer = ColorValuesContainer(),
    val borderWidth: BorderWidthValuesContainer = BorderWidthValuesContainer(),
    val borderRadius: BorderRadiusValuesContainer = BorderRadiusValuesContainer(),
    val size: SizeValuesContainer = SizeValuesContainer(),
    val space: SpaceValuesContainer = SpaceValuesContainer(),
    val opacity: OpacityValuesContainer = OpacityValuesContainer(),
    val typography: TypographyValuesContainer = TypographyValuesContainer(),
    val dimension: DimensionValuesContainer = DimensionValuesContainer(),
    val elevation: ElevationValuesContainer = ElevationValuesContainer(),
    val fontFamily: FontFamilyValuesContainer = FontFamilyValuesContainer(),
    val fontSize: FontSizeValuesContainer = FontSizeValuesContainer(),
    val fontWeight: FontWeightValuesContainer = FontWeightValuesContainer(),
    val letterSpacing: LetterSpacingValuesContainer = LetterSpacingValuesContainer(),
    val lineHeight: LineHeightValuesContainer = LineHeightValuesContainer(),
)
