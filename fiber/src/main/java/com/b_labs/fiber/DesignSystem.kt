...
object BorderValuesContainer {
    ...
    val infoSubtle = Color(parseColor("#e30404"))
    val successStrong = Color(parseColor("#347434"))
    val successSubtle = Color(parseColor("#0005ff"))
...
object PrimaryValuesContainer {
    ...
    val actionPrimarySubtleActive = Color(parseColor("#e30404"))
...
object SuccessValuesContainer {
    ...
    val actionSuccessSubtleActive = Color(parseColor("#0005ff"))
...
object DefaultValuesContainer {
    ...
    val interactionDefaultSubtleActive = Color(parseColor("#e30404"))
...
object BlueValuesContainer {
    ...
    val nonSemanticBlueBorderSubtle = Color(parseColor("#e30404"))
...
object GreenValuesContainer {
    ...
    val nonSemanticGreenBorderSubtle = Color(parseColor("#0005ff"))
...
object BrandValuesContainer {
    ...
    val semanticBrand3 = Color(parseColor("#e30404"))
...
object InfoValuesContainer {
    ...
    val semanticInfo3 = Color(parseColor("#e30404"))
...
object SuccessValuesContainer1 {
    ...
    val semanticSuccess3 = Color(parseColor("#0005ff"))
...
object BlueValuesContainer1 {
    ...
    val blue3 = Color(parseColor("#e30404"))
...
object GreenValuesContainer1 {
    ...
    val green3 = Color(parseColor("#0005ff"))
